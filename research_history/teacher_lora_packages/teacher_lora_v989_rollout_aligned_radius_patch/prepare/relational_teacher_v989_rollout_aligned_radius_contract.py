#!/usr/bin/env python3
"""Pure contract for Teacher-v9.8.9 rollout-aligned actual radius response."""
...
SCHEMA = "relational_teacher_v989_rollout_aligned_radius_v1"
POLICY_SCHEMA = "relational_teacher_v989_rollout_aligned_radius_policy_v1"
...
POLICY = {
    ...
    "decision_unit": "actual_two_scene_t50_to_t0_k3_rollout_aligned_radius_grid",
    "authority": "sealed_v988_pass_selected_audit_bed_guard_0p10_only",

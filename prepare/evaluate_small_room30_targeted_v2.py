#!/usr/bin/env python3
"""Targeted v2 accepted-candidate evaluator; unchanged sampler and Viser array format."""
import argparse
import json
import sys
...
def main():
    ...
    p.add_argument('--training-summary', type=Path, default=Path('outputs/small_room30_targeted_v2_run01/summary.json'))
    ...
    from small_room30_targeted_v2 import validate_run, FILES
    ...
    if (saved.get('schema') != TRAIN_SCHEMA or saved.get('purpose') != 'RESEARCH_TARGETED_V2_PILOT'

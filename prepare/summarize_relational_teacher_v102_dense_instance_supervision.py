#!/usr/bin/env python3
"""Concise Teacher-v10.2 result summary."""
...
def main() -> None:
    ...
    print("=== TEACHER-v10.2 DENSE PER-INSTANCE SUPPORT ===")
    ...
    print(
        "next authority:",
        "checkpoint lock" if value["status"] == "PASS" else "objective/architecture redesign",
    )

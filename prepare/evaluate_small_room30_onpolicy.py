#!/usr/bin/env python3
"""On-policy pilot evaluator; unchanged sampler and Viser array format."""
import argparse
import json
import sys
...
def main():
    ...
    p.add_argument('--training-summary', type=Path, default=Path('outputs/small_room30_onpolicy_run01/summary.json'))
    ...
    from small_room30_onpolicy import validate_run, FILES
    ...
    if (saved.get('schema') != TRAIN_SCHEMA or saved.get('purpose') != 'RESEARCH_ONPOLICY_PILOT'

#!/usr/bin/env python3
"""Print Teacher-v9.8.7 two-scene radius-response diagnostics."""
...
def main() -> None:
    ...
    print("=== TEACHER-v9.8.7 ACTUAL TWO-SCENE K=3 RADIUS RESPONSE ===")
    ...
    if value["status"] == "PASS":
        print("next authority: fresh two-scene common-direction calibration only")
    else:
